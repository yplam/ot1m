...
# usage ./src/gen_font.py -i DroidSansMono.ttf -s 24 -x 16 -y 32 -o font1632.c --hpack --msb-first
import argparse
import sys
...
static const uint8_t Font{width:d}{height:d}_Table[] = {{\n"""
...
sFONT Font{width}{height} = {{
        Font{width}{height}_Table,
        {width}, /* Width */
        {height}, /* Height */
}};
